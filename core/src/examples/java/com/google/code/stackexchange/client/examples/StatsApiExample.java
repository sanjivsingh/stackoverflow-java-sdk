...
public class StatsApiExample {
	...
	private static void printResult(List<Statistics> statsList) {
		for (Statistics stats : statsList) {
			System.out.println("Answers per minute:"
					+ stats.getAnswersPerMinute());
			System.out.println("Badges per minute:"
					+ stats.getBadgesPerMinute());
			System.out.println("Questions per minute:"
					+ stats.getQuestionsPerMinute());
			...
			System.out.println("Total unanswered questions:"
					+ stats.getTotalUnanswered());
			...
			System.out.println("API Version:"
					+ stats.getApiVersion().getVersion() + ":"
					+ stats.getApiVersion().getRevision());
