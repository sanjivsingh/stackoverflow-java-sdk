...
public final class ApplicationConstants {
	...
	public static final int DEFAULT_PAGE_SIZE = getIntProperty("com.google.code.stackexchange.client.defaultPageSize");

	/** The Constant DEFAULT_PAGE_NUMBER. */
	public static final int DEFAULT_PAGE_NUMBER = getIntProperty("com.google.code.stackexchange.client.defaultPageNumber");
