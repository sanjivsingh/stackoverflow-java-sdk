 ...
 */
public class BadgeApiQueryImpl extends BaseStackOverflowApiQuery<Badge>
		implements BadgeApiQuery {
	 ...
	 */
	public BadgeApiQueryImpl(String applicationId, StackExchangeSite site) {
	 ...
	 * 
	 * @see
	 * com.google.code.stackexchange.client.query.BadgeApiQuery#withUserIds(
	 * long[])
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.google.code.stackexchange.client.query.BadgeApiQuery#listByName()
	 */
	@Override
	public PagedList<Badge> listByName() {
		((DefaultApiUrlBuilder) apiUrlBuilder)
				.withMethod(StackExchangeApiMethods.GET_BADGES_BY_NAME);
		return super.list();
	}
	 ...
	 * 
	 * @see
	 * com.google.code.stackexchange.client.query.BadgeApiQuery#listByTags()
	 */
	@Override
	public PagedList<Badge> listByTags() {
		((DefaultApiUrlBuilder) apiUrlBuilder)
				.withMethod(StackExchangeApiMethods.GET_BADGES_BY_TAGS);
		return super.list();
	}
	...
	public PagedList<Badge> list() {
		((DefaultApiUrlBuilder) apiUrlBuilder)
				.withMethod(StackExchangeApiMethods.GET_BADGES);
		return super.list();
	}
	 ...
	 * 
	 * @see
	 * com.google.code.stackexchange.client.query.BadgeApiQuery#listByUsers()
	 */
	@Override
	public PagedList<Badge> listByUsers() {
		((DefaultApiUrlBuilder) apiUrlBuilder)
				.withMethod(StackExchangeApiMethods.GET_BADGES_FOR_USER);
		return super.list();
	}
