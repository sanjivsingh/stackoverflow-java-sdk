...
public abstract class StackExchangeApiClientTest extends TestCase {
	...
	public void setUp() throws Exception {
		assertNotNull(
				String.format(RESOURCE_MISSING_MESSAGE, "Application Key"),
				TestConstants.STACK_OVERFLOW_TEST_API_KEY);
		assertNotNull(
				String.format(RESOURCE_MISSING_MESSAGE, "Stack Exchange Site"),
	...
	protected Paging getPaging() {
		assertNotNullOrEmpty(
				String.format(RESOURCE_MISSING_MESSAGE, "Test Page No."),
				TestConstants.STACK_OVERFLOW_TEST_PAGE_NO);
		assertNotNullOrEmpty(
				String.format(RESOURCE_MISSING_MESSAGE, "Test Page Size"),
				TestConstants.STACK_OVERFLOW_TEST_PAGE_SIZE);
		return new Paging(
